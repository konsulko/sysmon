 ...
 * Copyright (C) 2016,2017,2018 Konsulko Group
 *
...
int main(int argc, char *argv[])
{
    ...
    if (positionalArguments.length() == 2) {
        ...
        context->setContextProperty("load", new Load(bindingAddress));
        ...
        engine.load(QUrl(QStringLiteral("qrc:/sysmon.qml")));
